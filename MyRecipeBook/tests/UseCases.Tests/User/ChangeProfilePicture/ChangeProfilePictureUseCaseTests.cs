...
public class ChangeProfilePictureUseCaseTests
{
    ...
    [Fact]
    public async Task Error_WhenTxt()
    {
        var useCase = CreateUseCase();
    ...
    [Fact]
    public async Task Error_WhenBmp()
    {
        var useCase = CreateUseCase();
    ...
    private static ChangeProfilePictureUseCase CreateUseCase()
    {
        ...
        return new ChangeProfilePictureUseCase(loggedUser, storageServiceBuilder, userUpdateRepositoryBuilder);
    }
}
